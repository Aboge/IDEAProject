...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static final String DIR = "day-01-code\\pic";
    ...
    private static JLabel input_bg_label = new JLabel(new ImageIcon("day-01-code\\pic\\01_input.jpg"));
