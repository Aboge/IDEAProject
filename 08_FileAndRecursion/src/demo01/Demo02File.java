...
public class Demo02File {
    ...
    * */
    private static void show01() {
        File f1 = new File("/IDEAProject//08_FileAndRecursion//a.txt");
        System.out.println(f1);//重写了Object类的toString方法

        File f2 = new File("/IDEAProject//08_FileAndRecursion");
        System.out.println(f2);//~/IDEAProject/08_FileAndRecursion
    ...
    * */
    ...
    public static void show03(){
        ...
        File file = new File(parent.getName(),"a.txt");
    }
}
