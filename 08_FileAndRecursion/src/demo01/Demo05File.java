...
//        show02();
    ...
    private static void show02() {
        ...
        File f2 = new File("08_FileAndRecursion/1/2/3");
        ...
        System.out.println("b4:"+b4);//false 不会创建
    }
    ...
    private static void show01() throws IOException {
        File f1 = new File("/Users/aboge/IDEAProject/08_FileAndRecursion/a.txt");
        boolean b1 = f1.createNewFile();
        System.out.println("b1:"+b1);//文件不存在，则创建成功，文件已经存在，则返回false

        File f2 = new File("08_FileAndRecursion/2.txt");
        System.out.println(f2.createNewFile());//true 相对路径创建成功  相对路径都是相对根目录IDEAProject文件夹

        File f3 = new File("08_FileAndRecursion/新建文件夹");
        System.out.println(f3.createNewFile());//true 创建了一个文件，不要被名称迷糊,要看类型
