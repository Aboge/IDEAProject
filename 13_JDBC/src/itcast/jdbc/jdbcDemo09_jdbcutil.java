...
/*
* 定义一个方法。查询emp表所有的数据将其封装为对象，然后装载集合，返回
* */
public class jdbcDemo09_jdbcutil {
    /*
    * 查询所有的emp对象
    *
    * */
    public List<Emp> findAll1(){  //定义一个List<Emp>类型的集合类型的方法，返回值是list类型
    ...
    public static void main(String[] args) {
        List<Emp> list = new jdbcDemo09_jdbcutil().findAll1();
